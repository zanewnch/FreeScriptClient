...
<template>
  <div class="xl:w-full md:h-screen">
    ...
    <div class="md:w-full md:flex md:justify-center">
      <div class="md:w-4/5 md:flex md:flex-col">
        <div class="md:text-left md:text-wrap">How To Detect An AI Written Article</div>
        <div class="md:text-left md:text-wrap">Paul</div>
        <div class="md:text-left md:text-wrap">
          In the Wild West of the internet, a new breed of gunslingers has emerged: AI content
          creators. These robotic wordsmiths churn out articles, blog posts, and even entire
          websites at breakneck speed, blurring the lines between human and machine-generated
          content. But fear not, discerning reader, for we, the Detectives of Discourse, are here to
          equip you with the tools to sniff out AI-written content like a bloodhound on the trail of
          a virtual rabbit.
        </div>
      </div>
    </div>
